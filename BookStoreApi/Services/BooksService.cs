...
namespace BookStoreApi.Services
{
    public class BooksService
    {
        ...
        public async Task<Book> GetAsync(string id) => await _booksCollection.Find(x => x.Id == id)
            .FirstOrDefaultAsync();
    ...
    /*
     ...
     o código anterior, uma BookStoreDatabaseSettings instância é recuperada do DI por meio de injeção de construtor. Essa técnica fornece acesso aos appsettings.json valores de configuração que foram adicionados
    */